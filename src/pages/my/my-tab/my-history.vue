...
let myHistory = computed(() => userStore.myHistory)
const userStore = useUserStore()
const getList = () => {
  return userStore.getMyHistory({
    ...pageOptions
  })
}
onMounted(async () => {
  await userStore.getMyHistory(pageOptions)
  pushArr.push(...myHistory.value.records)
})

const handleScroll = async () => {
  if (myHistory.value.total > pageOptions.page * pageOptions.pageSize) {
    pageOptions.page++
